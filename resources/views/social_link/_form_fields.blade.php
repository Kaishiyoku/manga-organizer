<div class="mb-4">
    <x-input.label for="order" :value="__('validation.attributes.order')" required/>
...
<div class="mb-4">
    <x-input.label for="url" :value="__('validation.attributes.url')" required/>
...
<div class="mb-4">
    <x-input.label for="title" :value="__('validation.attributes.title')" required/>
